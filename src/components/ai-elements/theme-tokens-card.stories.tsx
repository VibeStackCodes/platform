  ...
  args: {
    tokens: {
      ...
      colors: {
        ...
        foreground: 'oklch(0.2101 0.0318 264.66)',
        ...
        border: 'oklch(0.8717 0.0093 258.34)',
      },
      fonts: {
        display: 'Geist',
        body: 'Geist',
  ...
  args: {
    tokens: {
      ...
      colors: {
        ...
        foreground: 'oklch(0.2284 0.0384 282.93)',
        primary: 'oklch(0.6122 0.2082 22.24)',
        primaryForeground: 'oklch(1.0000 0 0)',
        secondary: 'oklch(0.9014 0.0389 66.04)',
        accent: 'oklch(0.5598 0.0781 237.98)',
        muted: 'oklch(0.9672 0 0)',
        border: 'oklch(0.8302 0.0332 76.40)',
      },
      fonts: {
