...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      "group flex w-full max-w-[768px] flex-col gap-2",
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-xl group-[.is-user]:rounded-br-md group-[.is-user]:bg-[#f0ede6] group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground",
