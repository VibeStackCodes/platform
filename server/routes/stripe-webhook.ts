...
stripeWebhookRoutes.post(
  ...
  describeRoute({
    ...
    description:
      'No auth middleware — Stripe calls this directly. Validates signature before processing.',
    tags: ['stripe'],
    ...
    requestBody: {
      ...
      content: {
        'text/plain': {
          schema: resolver(WebhookRequestSchema) as unknown as OpenAPIV3_1.SchemaObject,
        },
      },
    },
    responses: {
