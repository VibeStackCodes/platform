---
name: theme-colorstream
description: >
  Colorstream theme. 
  E-commerce focused layout. 
  
  Use when app mentions: colorstream, store, shop, commerce 
requires: []
...
- **elite-math**: "Elite Math, sans-serif"
...
### Notes
Extracted from WordPress.com theme "colorstream".
