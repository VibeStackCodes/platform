    ...
    return {
      '/': `
        ...
        export default function HomePage() {
          return (
            <div className="min-h-screen bg-[#f3f1f1] text-[#000000] font-['Albert Sans']">
              {/* Navigation */}
              <nav className="p-6 flex justify-between items-center border-b border-[#eaeaea]">
                <h1 className="text-2xl font-bold tracking-tight">Grammer</h1>
                <div className="space-x-4">
                  <a href="/about" className="hover:text-[#0c0c0e]">About</a>
              ...
              <main className="container mx-auto px-6 py-20 text-center">
                ...
                <Button size="lg" className="bg-[#0c0c0e] text-white px-8 py-6 text-lg rounded-full">
                  Shop Now
                </Button>
              </main>
