    ...
    return {
      '/': `
        ...
        export default function HomePage() {
          return (
            <div className="min-h-screen bg-[#f1f1f1] text-[#000000] font-['Albert Sans']">
              {/* Navigation */}
              <nav className="p-6 flex justify-between items-center border-b border-[#eaeaea]">
                ...
                <div className="space-x-4">
                  <a href="/about" className="hover:text-[#232323]">About</a>
              ...
              <main className="container mx-auto px-6 py-20 text-center">
                ...
                <Button size="lg" className="bg-[#232323] text-white px-8 py-6 text-lg rounded-full">
                  Shop Now
                </Button>
              </main>
