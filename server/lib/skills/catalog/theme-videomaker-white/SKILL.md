---
name: theme-videomaker-white
description: >
  Videomaker-white theme. 
  E-commerce focused layout. 
  
  Use when app mentions: videomaker-white, store, shop, commerce 
requires: []
...
### Notes
Extracted from WordPress.com theme "videomaker-white".
