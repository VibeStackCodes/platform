    ...
    return {
      '/': `
        ...
        export default function HomePage() {
          return (
            <div className="min-h-screen bg-[#292C6D] text-[#000000] font-['Albert Sans']">
              {/* Navigation */}
              <nav className="p-6 flex justify-between items-center border-b border-[#eaeaea]">
                <h1 className="text-2xl font-bold tracking-tight">Quadrat</h1>
                <div className="space-x-4">
                  <a href="/about" className="hover:text-[#FFD1D1]">About</a>
              ...
              <main className="container mx-auto px-6 py-20 text-center">
                ...
                <Button size="lg" className="bg-[#FFD1D1] text-white px-8 py-6 text-lg rounded-full">
                  Shop Now
                </Button>
              </main>
