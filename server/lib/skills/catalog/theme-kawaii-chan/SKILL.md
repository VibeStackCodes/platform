---
name: theme-kawaii-chan
description: >
  Kawaii-chan theme. 
  E-commerce focused layout. 
  
  Use when app mentions: kawaii-chan, store, shop, commerce 
requires: []
...
- **bellota-text**: "Bellota Text, sans-serif, system-ui"
...
### Notes
Extracted from WordPress.com theme "kawaii-chan".
