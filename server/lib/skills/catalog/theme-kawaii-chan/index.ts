          ...
          return (
            <div className="min-h-screen bg-[#ffffff] text-[#000000] font-['Albert Sans']">
              ...
              <nav className="p-6 flex justify-between items-center border-b border-[#eaeaea]">
                <h1 className="text-2xl font-bold tracking-tight">Kawaii-chan</h1>
                <div className="space-x-4">
                  <a href="/about" className="hover:text-[#ff4cb4]">About</a>
              ...
              <main className="container mx-auto px-6 py-20 text-center">
                ...
                <Button size="lg" className="bg-[#ff4cb4] text-white px-8 py-6 text-lg rounded-full">
                  Shop Now
                </Button>
              </main>
