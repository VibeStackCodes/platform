---
name: theme-twentytwentyfour
description: >
  Twentytwentyfour theme. 
  E-commerce focused layout. 
  Portfolio focus for creatives.
  Use when app mentions: twentytwentyfour, store, shop, commerce portfolio, gallery
requires: []
...
### Notes
Extracted from WordPress.com theme "twentytwentyfour".
