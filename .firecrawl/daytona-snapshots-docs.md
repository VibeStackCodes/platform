...
Snapshots are sandbox templates created from [Docker](https://www.docker.com/) or [OCI](https://opencontainers.org/) compatible images. Sandboxes can use a [default snapshot](https://www.daytona.io/docs/en/snapshots/#default-snapshots) or custom snapshots to provide a consistent and reproducible sandbox environments for your dependencies, settings, and resources.

Daytona supports running [Docker](https://www.daytona.io/docs/en/snapshots/#run-docker-in-a-sandbox) and [Kubernetes](https://www.daytona.io/docs/en/snapshots/#run-kubernetes-in-a-sandbox) workloads inside sandboxes using snapshots.

## [\#](https://www.daytona.io/docs/en/snapshots/\#create-snapshots) Create Snapshots

Daytona provides methods to create snapshots using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/snapshots) or programmatically using the Daytona [Python](https://www.daytona.io/docs/en/python-sdk/sync/snapshot), [TypeScript](https://www.daytona.io/docs/en/typescript-sdk/snapshot), [Ruby](https://www.daytona.io/docs/en/ruby-sdk/snapshot), [Go](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService) **SDKs**, [CLI](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot), or [API](https://www.daytona.io/docs/en/tools/api#daytona/tag/snapshots).

Snapshots can be created using:

- [public images](https://www.daytona.io/docs/en/snapshots/#using-public-images)
- [local images](https://www.daytona.io/docs/en/snapshots/#using-local-images)
- [images from private registries](https://www.daytona.io/docs/en/snapshots/#using-images-from-private-registries)
- [the declarative builder](https://www.daytona.io/docs/en/snapshots/#using-the-declarative-builder)
...
- [**Resources**](https://www.daytona.io/docs/en/sandboxes#resources) (optional): The resources you want the underlying Sandboxes to have. By default, Daytona Sandboxes use **1 vCPU**, **1GiB memory**, and **3GiB storage**.

- [Python](https://www.daytona.io/docs/en/snapshots/#tab-panel-558)
- [TypeScript](https://www.daytona.io/docs/en/snapshots/#tab-panel-559)
- [Ruby](https://www.daytona.io/docs/en/snapshots/#tab-panel-560)
- [Go](https://www.daytona.io/docs/en/snapshots/#tab-panel-561)
- [CLI](https://www.daytona.io/docs/en/snapshots/#tab-panel-562)
- [API](https://www.daytona.io/docs/en/snapshots/#tab-panel-563)
...
For more information, see the [Python SDK](https://www.daytona.io/docs/en/python-sdk/sync/snapshot), [TypeScript SDK](https://www.daytona.io/docs/en/typescript-sdk/snapshot), [Ruby SDK](https://www.daytona.io/docs/en/ruby-sdk/snapshot), [Go SDK](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService.Create), [CLI](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot), and [API](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots) references:

> [**create (Python SDK)**](https://www.daytona.io/docs/en/python-sdk/sync/snapshot#snapshotservicecreate)
>
> [**create (TypeScript SDK)**](https://www.daytona.io/docs/en/typescript-sdk/snapshot#create)
>
> [**create (Ruby SDK)**](https://www.daytona.io/docs/en/ruby-sdk/snapshot/#create)
>
> [**create (Go SDK)**](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService.Create)
>
> [**create (CLI)**](https://www.daytona.io/docs/en/tools/cli/#daytona-snapshot-create)
>
> [**create (API)**](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots/POST/snapshots)

### [\#](https://www.daytona.io/docs/en/snapshots/\#using-public-images) Using public images
...
- [Python](https://www.daytona.io/docs/en/snapshots/#tab-panel-564)
- [TypeScript](https://www.daytona.io/docs/en/snapshots/#tab-panel-565)
- [Ruby](https://www.daytona.io/docs/en/snapshots/#tab-panel-566)
- [Go](https://www.daytona.io/docs/en/snapshots/#tab-panel-567)
- [CLI](https://www.daytona.io/docs/en/snapshots/#tab-panel-568)
- [API](https://www.daytona.io/docs/en/snapshots/#tab-panel-569)
...
### [\#](https://www.daytona.io/docs/en/snapshots/\#using-local-images) Using local images

Daytona supports creating snapshots from local images or from local Dockerfiles. To create a snapshot from a local image or from a local Dockerfile, use the [Daytona CLI](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot).
...
### [\#](https://www.daytona.io/docs/en/snapshots/\#using-images-from-private-registries) Using images from private registries

Daytona supports creating snapshots from images from [Docker Hub](https://www.daytona.io/docs/en/snapshots/#docker-hub), [Google Artifact Registry](https://www.daytona.io/docs/en/snapshots/#google-artifact-registry), [GitHub Container Registry](https://www.daytona.io/docs/en/snapshots/#github-container-registry) or other private container registries.
...
#### [\#](https://www.daytona.io/docs/en/snapshots/\#github-container-registry-ghcr) GitHub Container Registry (GHCR)
...
### [\#](https://www.daytona.io/docs/en/snapshots/\#using-the-declarative-builder) Using the declarative builder

[Declarative Builder](https://www.daytona.io/docs/en/declarative-builder) provides a powerful, code-first approach to defining dependencies for Daytona Sandboxes. Instead of importing images from a container registry, you can programmatically define them using the Daytona [SDKs](https://www.daytona.io/docs/en/getting-started#sdks).

### [\#](https://www.daytona.io/docs/en/snapshots/\#resources) Resources

Snapshots can be customized with specific resource requirements. By default, Daytona Sandboxes use **1 vCPU**, **1GB RAM**, and **3GiB disk**. For more information, see [sandbox resources](https://www.daytona.io/docs/en/sandboxes#resources).

To view your available resources and limits, see [limits](https://www.daytona.io/docs/en/limits) or navigate to [Daytona Limits ↗](https://app.daytona.io/dashboard/limits).

Snapshot resources can be customized using the `Resources` class.

- [Python](https://www.daytona.io/docs/en/snapshots/#tab-panel-570)
- [TypeScript](https://www.daytona.io/docs/en/snapshots/#tab-panel-571)
- [Ruby](https://www.daytona.io/docs/en/snapshots/#tab-panel-572)
- [Go](https://www.daytona.io/docs/en/snapshots/#tab-panel-573)
- [CLI](https://www.daytona.io/docs/en/snapshots/#tab-panel-574)
- [API](https://www.daytona.io/docs/en/snapshots/#tab-panel-575)
...
For more information, see the [Python SDK](https://www.daytona.io/docs/en/python-sdk), [TypeScript SDK](https://www.daytona.io/docs/en/typescript-sdk), [Ruby SDK](https://www.daytona.io/docs/en/ruby-sdk), [Go SDK](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService.Create), [CLI](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot-create), and [API](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots) references:

> [**CreateSnapshotParams (Python SDK)**](https://www.daytona.io/docs/en/python-sdk/sync/snapshot#createsnapshotparams)
>
> [**CreateSnapshotParams (TypeScript SDK)**](https://www.daytona.io/docs/en/typescript-sdk/snapshot#createsnapshotparams)
>
> [**CreateSnapshotParams (Ruby SDK)**](https://www.daytona.io/docs/en/ruby-sdk/snapshot#create)
>
> [**CreateSnapshotParams (Go SDK)**](https://www.daytona.io/docs/en/go-sdk/types#CreateSnapshotParams)
>
> [**create (CLI)**](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot-create)
>
> [**create (API)**](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots/POST/snapshots)

### [\#](https://www.daytona.io/docs/en/snapshots/\#regions) Regions

When creating a snapshot, you can specify the [region](https://www.daytona.io/docs/en/regions) in which it will be available. If not specified, the snapshot will be created in your organization’s default region.
...
- [Python](https://www.daytona.io/docs/en/snapshots/#tab-panel-576)
- [TypeScript](https://www.daytona.io/docs/en/snapshots/#tab-panel-577)
- [Ruby](https://www.daytona.io/docs/en/snapshots/#tab-panel-578)
- [CLI](https://www.daytona.io/docs/en/snapshots/#tab-panel-579)
- [API](https://www.daytona.io/docs/en/snapshots/#tab-panel-580)
...
For more information, see the [Python SDK](https://www.daytona.io/docs/en/python-sdk/sync/snapshot), [TypeScript SDK](https://www.daytona.io/docs/en/typescript-sdk/snapshot), [Ruby SDK](https://www.daytona.io/docs/en/ruby-sdk/snapshot), [CLI](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot-create), and [API](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots) references:
...
## [\#](https://www.daytona.io/docs/en/snapshots/\#get-a-snapshot-by-name) Get a Snapshot by name

Daytona provides an option to get a snapshot by name.

The following snippet returns the snapshot with the specified name:

- [Python](https://www.daytona.io/docs/en/snapshots/#tab-panel-581)
- [TypeScript](https://www.daytona.io/docs/en/snapshots/#tab-panel-582)
- [Ruby](https://www.daytona.io/docs/en/snapshots/#tab-panel-583)
- [Go](https://www.daytona.io/docs/en/snapshots/#tab-panel-584)
- [API](https://www.daytona.io/docs/en/snapshots/#tab-panel-585)
...
For more information, see the [Python SDK](https://www.daytona.io/docs/en/python-sdk/sync/snapshot#snapshotserviceget), [TypeScript SDK](https://www.daytona.io/docs/en/typescript-sdk/snapshot#get), [Ruby SDK](https://www.daytona.io/docs/en/ruby-sdk/snapshot#get), [Go SDK](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService.Get), and [API](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots) references:

> [**get (Python SDK)**](https://www.daytona.io/docs/en/python-sdk/sync/snapshot#snapshotserviceget)
>
> [**get (TypeScript SDK)**](https://www.daytona.io/docs/en/typescript-sdk/snapshot#get)
>
> [**get (Ruby SDK)**](https://www.daytona.io/docs/en/ruby-sdk/snapshot#get)
>
> [**get (Go SDK)**](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService.Get)
>
> [**get (API)**](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots/GET/snapshots/%7BsnapshotName%7D)
...
- [Python](https://www.daytona.io/docs/en/snapshots/#tab-panel-586)
- [TypeScript](https://www.daytona.io/docs/en/snapshots/#tab-panel-587)
- [Ruby](https://www.daytona.io/docs/en/snapshots/#tab-panel-588)
- [Go](https://www.daytona.io/docs/en/snapshots/#tab-panel-589)
- [CLI](https://www.daytona.io/docs/en/snapshots/#tab-panel-590)
- [API](https://www.daytona.io/docs/en/snapshots/#tab-panel-591)
...
For more information, see the [Python SDK](https://www.daytona.io/docs/en/python-sdk/sync/snapshot), [TypeScript SDK](https://www.daytona.io/docs/en/typescript-sdk/snapshot), [Ruby SDK](https://www.daytona.io/docs/en/ruby-sdk/snapshot), [Go SDK](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService.List), [CLI](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot-list), and [API](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots) references.

> [**list (Python SDK)**](https://www.daytona.io/docs/en/python-sdk/sync/snapshot#snapshotservicelist)
>
> [**list (TypeScript SDK)**](https://www.daytona.io/docs/en/typescript-sdk/snapshot#list)
>
> [**list (Ruby SDK)**](https://www.daytona.io/docs/en/ruby-sdk/snapshot#list)
>
> [**list (Go SDK)**](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService.List)
>
> [**list (CLI)**](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot-list)
>
> [**list (API)**](https://www.daytona.io/docs/en/tools/api#daytona/tag/snapshots/GET/snapshots)
...
- [Python](https://www.daytona.io/docs/en/snapshots/#tab-panel-592)
- [TypeScript](https://www.daytona.io/docs/en/snapshots/#tab-panel-593)
- [Ruby](https://www.daytona.io/docs/en/snapshots/#tab-panel-594)
- [API](https://www.daytona.io/docs/en/snapshots/#tab-panel-595)
...
For more information, see the [Python SDK](https://www.daytona.io/docs/en/python-sdk/sync/snapshot#snapshotserviceactivate), [TypeScript SDK](https://www.daytona.io/docs/en/typescript-sdk/snapshot#activate), [Ruby SDK](https://www.daytona.io/docs/en/ruby-sdk/snapshot#activate), and [API](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots) references:

> [**activate (Python SDK)**](https://www.daytona.io/docs/en/python-sdk/sync/snapshot#snapshotserviceactivate)
>
> [**activate (TypeScript SDK)**](https://www.daytona.io/docs/en/typescript-sdk/snapshot#activate)
>
> [**activate (Ruby SDK)**](https://www.daytona.io/docs/en/ruby-sdk/snapshot#activate)
>
> [**activate (API)**](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots/POST/snapshots/%7BsnapshotName%7D/activate)
...
- [Python](https://www.daytona.io/docs/en/snapshots/#tab-panel-596)
- [TypeScript](https://www.daytona.io/docs/en/snapshots/#tab-panel-597)
- [Ruby](https://www.daytona.io/docs/en/snapshots/#tab-panel-598)
- [Go](https://www.daytona.io/docs/en/snapshots/#tab-panel-599)
- [CLI](https://www.daytona.io/docs/en/snapshots/#tab-panel-600)
- [API](https://www.daytona.io/docs/en/snapshots/#tab-panel-601)
...
For more information, see the [Python SDK](https://www.daytona.io/docs/en/python-sdk/sync/snapshot#snapshotservicedelete), [TypeScript SDK](https://www.daytona.io/docs/en/typescript-sdk/snapshot#delete), [Ruby SDK](https://www.daytona.io/docs/en/ruby-sdk/snapshot#delete), [Go SDK](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService.Delete), [CLI](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot-delete), and [API](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots) references:

> [**delete (Python SDK)**](https://www.daytona.io/docs/en/python-sdk/sync/snapshot#snapshotservicedelete)
>
> [**delete (TypeScript SDK)**](https://www.daytona.io/docs/en/typescript-sdk/snapshot#delete)
>
> [**delete (Ruby SDK)**](https://www.daytona.io/docs/en/ruby-sdk/snapshot#delete)
>
> [**delete (Go SDK)**](https://www.daytona.io/docs/en/go-sdk/daytona#SnapshotService.Delete)
>
> [**delete (CLI)**](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot-delete)
>
> [**delete (API)**](https://www.daytona.io/docs/en/tools/api/#daytona/tag/snapshots/DELETE/snapshots/%7BsnapshotName%7D)
...
#### [\#](https://www.daytona.io/docs/en/snapshots/\#using-pre-built-images) Using pre-built images
...
#### [\#](https://www.daytona.io/docs/en/snapshots/\#using-manual-installation) Using manual installation
...
First, create a Docker-in-Docker snapshot using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/snapshots) or [CLI](https://www.daytona.io/docs/en/tools/cli#daytona-snapshot-create) with one of the [pre-built images](https://www.daytona.io/docs/en/snapshots/#using-pre-built-images) (e.g., `docker:28.3.3-dind`). Then use the following snippet to run Docker Compose services inside a sandbox:

- [Python](https://www.daytona.io/docs/en/snapshots/#tab-panel-602)
- [TypeScript](https://www.daytona.io/docs/en/snapshots/#tab-panel-603)
- [Ruby](https://www.daytona.io/docs/en/snapshots/#tab-panel-604)
- [Go](https://www.daytona.io/docs/en/snapshots/#tab-panel-605)
...
### [\#](https://www.daytona.io/docs/en/snapshots/\#run-k3s-in-a-sandbox) Run k3s in a Sandbox
...
### [\#](https://www.daytona.io/docs/en/snapshots/\#python-packages-pip) Python packages (pip)
...
### [\#](https://www.daytona.io/docs/en/snapshots/\#nodejs-packages-npm) Node.js packages (npm)
