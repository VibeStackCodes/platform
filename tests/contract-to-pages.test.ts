...
describe('contractToPages', () => {
  ...
  it('includes placeholder comment header', () => {
    const pages = contractToPages(simpleContract)

    expect(pages[0].content).toContain('// Placeholder — replaced by assembler during code generation')
    expect(pages[1].content).toContain('// Placeholder — replaced by assembler during code generation')
  })

  it('content contains entity name', () => {
    const pages = contractToPages(simpleContract)
  ...
  it('content contains route path', () => {
    const pages = contractToPages(simpleContract)

    expect(pages[0].content).toContain('// Route: /_authenticated/tasks')
    expect(pages[1].content).toContain('// Route: /_authenticated/tasks/$id')
  })
  ...
  it('handles snake_case table names with kebab-case conversion', () => {
    ...
    // Entity name is preserved in content
