...
describe('Database Browser E2E: Introspection Pipeline', () => {
  ...
  it('proxies the introspection query through the authenticated proxy', async () => {
    ...
    const chainedMock = { single: vi.fn().mockResolvedValue({ data: { id: 'proj-1' }, error: null }) };
...
describe('Database Browser E2E: Edit Row Pipeline', () => {
  it('validates form data and constructs correct UPDATE SQL', async () => {
    ...
    const table = {
      name: 'orders',
      columns: [
        { name: 'id', data_type: 'uuid', is_updatable: false, is_generated: true, is_nullable: false },
        { name: 'amount', data_type: 'numeric', is_updatable: true, is_generated: false, is_nullable: false },
        { name: 'customer_name', data_type: 'text', is_updatable: true, is_generated: false, is_nullable: false },
        { name: 'notes', data_type: 'text', is_updatable: true, is_generated: false, is_nullable: true },
        { name: 'is_paid', data_type: 'boolean', is_updatable: true, is_generated: false, is_nullable: false },
        { name: 'tags', data_type: 'ARRAY', is_updatable: true, is_generated: false, is_nullable: true },
        {
          name: 'status',
          data_type: 'USER-DEFINED',
  ...
  it('handles composite primary keys in the edit flow', async () => {
    ...
    const joinTable = {
      name: 'user_roles',
      columns: [
        { name: 'user_id', data_type: 'uuid', is_updatable: false, is_generated: false, is_nullable: false },
        { name: 'role_id', data_type: 'uuid', is_updatable: false, is_generated: false, is_nullable: false },
        { name: 'granted_at', data_type: 'timestamp', is_updatable: true, is_generated: false, is_nullable: true },
      ],
