...
describe('contractToDrizzleSchema', () => {
  ...
  it('handles self-referential foreign keys', () => {
    ...
    expect(result).toContain("parentId: uuid('parent_id').references(() => categories.id, { onDelete: 'cascade' })");
  });
  ...
  it('adds onDelete cascade to foreign key references', () => {
    ...
    expect(result).toContain("postId: uuid('post_id').references(() => posts.id, { onDelete: 'cascade' })");
  });
