...
describe.skip('Supabase Proxy Route', () => {
  ...
  describe('Authorization', () => {
    it('returns 403 when user does not own the project', async () => {
      ...
      const req = new NextRequest(
        'http://localhost:3000/api/supabase-proxy/v1/projects/abc123/database/query',
      )
  ...
  describe('Request forwarding', () => {
    ...
    it('successfully proxies GET request with correct URL and headers', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('https://api.supabase.com/v1/organizations', {
        method: 'GET',
        headers: {
    ...
    it('successfully proxies POST request with body forwarding', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('https://api.supabase.com/v1/projects', {
        method: 'POST',
        headers: {
          Authorization: 'Bearer test-token',
          'Content-Type': 'application/json',
  ...
  describe('Path parsing', () => {
    ...
    it('extracts project ref from complex path', async () => {
      ...
      const req = new NextRequest(
        'http://localhost:3000/api/supabase-proxy/v1/projects/xyz789/database/tables/users/columns',
      )
      const params = {
        path: ['v1', 'projects', 'xyz789', 'database', 'tables', 'users', 'columns'],
      }
